...
class RoleManage extends Component {
    ...
    // 编辑和添加
    addEditModal(){
        const {modalTitle,addEditVisible,role_name,role_flag,permissionsAllList,permissionsList,permissionsOption,roleflag_status,rolename_status,noChoice} = this.state;
        return (
            <Modal
                title={modalTitle}
                ...
                <div>
                    ...
                    <div className="params" style={{marginTop:'10px'}}>
                        <FormItem {...formItemLayout} label={<span><i>*</i>角色名称</span>} validateStatus={rolename_status}>
                    ...
                    <div className="params">
                        <FormItem {...formItemLayout} label={<span><i>*</i>角色标识</span>} validateStatus={roleflag_status}>
                ...
                <div>
                    ...
                    <div className="warp" style={{marginTop:'10px'}}>
                        ...
                        <CheckboxGroup options={permissionsOption} value={permissionsList}
                                       disabled={this.state.isLook}
                                       onChange={(checkedList) => {
                                           this.setState({
                                               permissionsList: checkedList,
                                               Indeterminate1: !!checkedList.length && (checkedList.length < permissionsOption.length),
    ...
    handleModelOk(){
        const {isAdd,role_flag,role_name,permissionsList,platform_id,role_id} = this.state;
